function Update-Header ($header) {
  ...
  Update-Header "1. Determining matching Azure Pipelines agent..."
  ...
  Update-Header "2. Downloading and installing Azure Pipelines agent..."
  ...
  try {
    Update-Header "3. Configuring Azure Pipelines agent..."
  ...
  Update-Header "4. Running Azure Pipelines agent..."
  
  .\run.cmd
  } finally {
    Update-Header "Cleanup. Removing Azure Pipelines agent..."
